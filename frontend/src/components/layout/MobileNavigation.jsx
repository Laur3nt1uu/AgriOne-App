...
export default function MobileNav() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-around px-1 py-1.5 sm:px-2 sm:py-2 relative z-10 overflow-x-auto scrollbar-none gap-0.5">
          ...
          return (
            ...
            >
              <Motion.div
                ...
                whileTap={{ scale: 0.9 }}
                className={`flex flex-col items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-1.5 sm:py-2 rounded-xl transition-all duration-300 min-w-[40px] sm:min-w-[44px] relative ${
                  isActive
                    ? "text-primary"
              ...
              >
                ...
                <span className="text-[10px] sm:text-xs font-medium relative z-10 truncate max-w-[48px] text-center">{item.label}</span>
              </Motion.div>
            </NavLink>
          );
        })}
